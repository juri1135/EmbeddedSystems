...
// RS: Register select instruction regi(0)인지 data regi(1)인지 
// DB7: Set DDRAM Address 1=>set ddream address to input value
...
void initializeLCD()
{
  ...
  // 1000 0000 rs=0, rw=0, db7=1, address=0
  // second line -> address=40, rs=0, rw=0, db7=1, 0x40=0100 0000 => 1100 0000
